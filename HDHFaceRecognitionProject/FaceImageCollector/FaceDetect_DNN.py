...
class FaceDetectDNN():
    ...
    def LoadModel(self, ModelPath, ConfigPath):
        ...
        self.net = cv2.dnn.readNetFromTensorflow(ModelPath, ConfigPath)
    ...
    def FindFace(self, srcImage):
         if(self.net is None):
             return False
                
         # prepare input
         result_img = srcImage.copy()
         h, w, _ = result_img.shape
         blob = cv2.dnn.blobFromImage(result_img, 1.0, (self.NetScaleX, self.NetScaleY), [104, 117, 123], False, False)
